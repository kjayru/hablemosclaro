...
<div id="search" class="search">
	<div class="search__content">
		...
		<form action="/hablandoclaro/search_results.json" class="search__form fnSearchForm" method="post" data-tipo="search_form">
			<input type="text" name="q" placeholder="Buscar en Hablando Claro" class="search__form__input fnSearchFormInput">
			<button type="submit" class="search__form__button">Buscar</button>
			<img src="/assets/public/images/ico_clean_search.png" alt="Limpiar busqueda" loading="lazy" class="search__form__clean fnSearchFormClean">
		</form>
...
<section class="section limit m--detalle detalle_de_articulos">
	<article class="detalle_de_articulos__article">
		<figure class="detalle_de_articulos__article__image">
			<img src="/assets/public/images/detalle.png" alt="">
		</figure>
		<header class="columnas__item__header">
			<strong class="columnas__item__subtitle">Compromiso</strong>
			<h3 class="columnas__item__title">Telecomunicaciones: Conectados para el teletrabajo, la teleducación , la telesalud y el entretenimiento digital</h3>
		...
		<div class="detalle_de_articulos__article__content">
			<p>Aunque la nueva normalidad nos exige mantener el distanciamiento social, gracias a las telecomunicaciones seguimos juntos. Reunidos en una videollamada familiar, celebrando el cumpleaños de un amigo, trabajando en equipo desde una plataforma, estudiando con nuestros compañeros desde casa, compartiendo en redes sociales, chateando con tu persona favorita o jugando en línea con tus patas. Todo esto es posible porque estamos conectados.</p>
			<p>Y aunque muchas veces no reflexionemos al respecto, detrás de cada conexión que disfrutamos hay gente trabajando. En Claro, por ejemplo, un gran equipo de profesionales labora arduamente para garantizar la continuidad de tus servicios, incluso en tiempos de emergencia sanitaria. Por ello, en esta nota repasaremos las iniciativas más importantes desplegadas por la empresa para hacer realidad el Teletrabajo, la Teleducación, la Telesalud, la Autogestión y también el Entretenimiento Digital en la nueva normalidad.</p>
		</div>
		...
		<div class="detalle_de_articulos__article__simple-slide fnSetSwiper" data-swiper="scroll_bottom" data-swiper-activate="active">
		...
		<div class="detalle_de_articulos__article__simple-slide m--one fnSetSwiper" data-swiper="one_image" data-swiper-activate="active" data-swiper-arrows="/assets/public/images/ico_arrow_verde.png">
		...
		<ul class="detalle_de_articulos__article__simple-slide fnSetSwiper" data-swiper="scroll_bottom" data-swiper-activate="active">
		...
		<aside class="detalle_de_articulos__article__links">
			...
			<p>Si ya tienes tu chip Claro, ya puedes activarlo tú mismo. <strong>Revisa el tutorial que necesitas para:</strong></p>
			<ul>
				<li><a href="#">Reponer tu número Prepago o Postpago <img src="/assets/public/images/ico_nav-arrow.png" loading="lazy" /></a></li>
				<li><a href="#">Activar una línea nueva Postpago <img src="/assets/public/images/ico_nav-arrow.png" loading="lazy" /></a></li>
				<li><a href="#">Cambiarte a Claro Prepago <img src="/assets/public/images/ico_nav-arrow.png" loading="lazy" /></a></li>
				<li><a href="#">Activar una línea nueva Postpago <img src="/assets/public/images/ico_nav-arrow.png" loading="lazy" /></a></li>
				<li><a href="#">Reponer tu número Prepago o Postpago <img src="/assets/public/images/ico_nav-arrow.png" loading="lazy" /></a></li>
			</ul>
		</aside>
		...
		<aside class="detalle_de_articulos__article__myths">
			<strong class="detalle_de_articulos__article__myths__title">¿Es preferible usar cargadores originales?</strong>
			...
			<div class="detalle_de_articulos__article__content">
				<p>Los cargadores originales están desarrollados para cargar de forma adecuada y segura los terminales. Es decir que si tu smartphone soporta una carga rápida de 25W, el cargador será compatible con esta velocidad y ofrecerá una carga equilibrada y segura, mientras que usar un cargador genérico será incompatible por tecnologías diferentes como potencia.</p>
        ...
        <dl class="detalle_de_articulos__article__author">
			<dt class="detalle_de_articulos__article__author__header">
				...
				<p>Tech Blogger, Lead Editor de Perusmart.com</p>
				<aside>
					<a href="#"><img src="/assets/public/images/ico_twitter_white.png" alt="" loading="lazy">@soynubeparlante</a>
					<a href="#"><img src="/assets/public/images/ico_linkedin_white.png" alt="" loading="lazy">@soynubeparlante</a>
					<span class="detalle_de_articulos__article__author__button fnShowArticleAuthor"><img src="/assets/public/images/ico_plus_white.png" alt=""></span>
				</aside>
			</dt>
			<dl class="detalle_de_articulos__article__content">
				...
				<ul>
					...
					<li>Con esta velocidad y ofrecerá una carga <strong>equilibrada y segura, mientras</strong> que usar un cargador genérico será incompatible por tecnologías diferentes como potencia.</li>
					<li>Los cargadores originales están desarrollados.</li>
				</ul>
				<p>Respuesta por <a href="#">Gianmarco Cárdenas</a></p>
				<ol>
    ...
    <aside class="detalle_de_articulos__sidebar">
		<form action="" method="post" class="detalle_de_articulos__subscribe">
			...
			<p class="detalle_de_articulos__subscribe__text">Y recibe lo mejor de nuestro contenido todas las semanas</p>
			<input type="email" name="email" placeholder="Correo electrónico" class="detalle_de_articulos__subscribe__input" />
		...
		<section class="detalle_de_articulos__recomendados">
			<h4 class="detalle_de_articulos__recomendados__title">Te puede interesar</h4>
				...
				<header class="columnas__item__header">
					<strong class="columnas__item__subtitle">Compromiso</strong>
					<h3 class="columnas__item__title">Conectados para el teletrabajo, la teleducación, la telesalud y teletrabajososo</h3>
					<aside class="columnas__item__timer">5 min de lectura</aside>
				</header>
	...
	<aside class="detalle_de_articulos__socials">
				<a href="#"><img src="/assets/public/images/social_facebook.png" alt="Compartir en Facebook" loading="lazy" /></a>
				<a href="#"><img src="/assets/public/images/social_twitter.png" alt="Compartir en Facebook" loading="lazy" /></a>
				...
				<a href="#"><img src="/assets/public/images/social_linkedin.png" alt="Compartir en Facebook" loading="lazy" /></a>
				<a href="#"><img src="/assets/public/images/social_msn.png" alt="Compartir en Facebook" loading="lazy" /></a>
				<a href="#"><img src="/assets/public/images/social_telegram.png" alt="Compartir en Facebook" loading="lazy" /></a>
				<a href="#"><img src="/assets/public/images/social_pinterest.png" alt="Compartir en Facebook" loading="lazy" /></a>
