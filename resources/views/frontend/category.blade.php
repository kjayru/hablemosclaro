...
</div><aside class="limit breadcrumb">
...
<section class="section limit listado_de_articulos">
	<header class="listado_de_articulos__header">
		...
		<img src="/assets/public/images/ico_show_filter.png" loading="lazy" alt="Mostrar filtros" class="listado_de_articulos__showfilter fnShowFilter" />
	</header>
	<nav class="listado_de_articulos__nav">
		<ul class="listado_de_articulos__nav__inset">
			<li class="listado_de_articulos__nav__item"><a href="#" class="listado_de_articulos__nav__link">Todo</a></li>
			<li class="listado_de_articulos__nav__item"><a href="#" class="listado_de_articulos__nav__link -active-">Empresas</a></li>
			<li class="listado_de_articulos__nav__item"><a href="#" class="listado_de_articulos__nav__link">Emprendimientos</a></li>
		</ul>
		<form id="filtro_de_articulos" action="" method="get" class="listado_de_articulos__filter">
			<strong class="listado_de_articulos__filter__title">Organizar por:<span class="header__button-mobile -active- fnCloseFilter"><span></span></span></strong>
	...
	<div class="listado_de_articulos__list">
			...
			<a href="/negocios/detalle-de-articulos/articulo" class="columnas__item__link">Más información</a>
		</article>
				<article class="columnas__item">
			<picture class="columnas__item__image">
				<img src="/assets/public/images/columnas.png" alt="" loading="lazy">
...
</section><section class="section columnas">
...
</section><section class="section m--bg ultimos_videos">
	<div class="limit">
		...
		<div class="ultimos_videos__list">
			<article class="ultimos_videos__item m--principal fnShowVideoTarget">
				<iframe class="ultimos_videos__item__video" src="https://www.youtube-nocookie.com/embed/eZqPTacPn-g" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></iframe>
